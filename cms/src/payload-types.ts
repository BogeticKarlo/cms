...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'lesson-pages': LessonPagesSelect<false> | LessonPagesSelect<true>;
...
export interface Lesson {
  ...
  description: string;
  /**
   * Upload the hero image for the lesson
   */
  heroImage: number | MediaImage;
  /**
   * Upload the video for the lesson
   */
  video: number | MediaVideo;
  updatedAt: string;
  createdAt: string;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "lesson-pages".
 */
export interface LessonPage {
  ...
  order: number;
  /**
   * Select the lessons to include in this lesson page
   */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'lesson-pages';
        value: number | LessonPage;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "lesson-pages_select".
 */
